...
function PhoneFrame({ children }) {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(to bottom, #fff7ed 0%, #fffbf7 50%, #ffffff 100%)",
      }}
    >
      <div className="w-full max-w-sm rounded-[2.5rem] bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 shadow-2xl border-8 border-zinc-900 overflow-hidden min-h-[760px] relative">
        ...
        <div className="p-5 relative overflow-hidden">
          <div className="absolute inset-0 pointer-events-none opacity-10 text-4xl">
            <div className="absolute top-8 left-6">🍜</div>
            <div className="absolute top-20 right-8">🍣</div>
            <div className="absolute top-48 left-4">🍛</div>
            <div className="absolute top-72 right-6">🍗</div>
            <div className="absolute bottom-32 left-8">🍱</div>
            <div className="absolute bottom-12 right-10">🥘</div>
          </div>
